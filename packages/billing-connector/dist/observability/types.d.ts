export declare const BILLING_CONNECTOR_SYNC_SOURCE: "billing_connector.sync";
export type BillingConnectorSyncStatus = "RUNNING" | "SUCCESS" | "FAILED" | "PARTIAL" | "TIMEOUT";
