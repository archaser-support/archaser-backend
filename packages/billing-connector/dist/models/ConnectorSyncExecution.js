...
const EntitySyncStatsSchema = new mongoose_1.Schema({
...
const ConnectorSyncExecutionSchema = new mongoose_1.Schema({
    ...
    mapping_snapshot_hash: { type: mongoose_1.Schema.Types.Mixed, default: null },
    import_job_ids: { type: mongoose_1.Schema.Types.Mixed, default: null },
    error_message: { type: String, default: null },
    error_type: { type: String, default: null },
    error_details: { type: mongoose_1.Schema.Types.Mixed, default: null },
    performance_metrics: { type: mongoose_1.Schema.Types.Mixed, default: null },
}, {
...
ConnectorSyncExecutionSchema.statics.findByConnectorId = function (connectorId, limit = 50) {
    return this.find({ connector_id: connectorId })
        .sort({ started_at: -1 })
        .limit(limit);
};
ConnectorSyncExecutionSchema.statics.findStaleRunning = function (connectorId, olderThan) {
    return this.find({
...
ConnectorSyncExecutionSchema.statics.findLatestRunning = function (connectorId) {
    return this.findOne({
        connector_id: connectorId,
        status: "RUNNING",
    }).sort({ started_at: -1 });
};
const ConnectorSyncExecution = mongoose_1.default.models.ConnectorSyncExecution ||
    mongoose_1.default.model("ConnectorSyncExecution", ConnectorSyncExecutionSchema);
exports.default = ConnectorSyncExecution;
