...
exports.isTransientEmailError = isTransientEmailError;
exports.getEmailErrorSummary = getEmailErrorSummary;
exports.getEmailTransientMaxRetries = getEmailTransientMaxRetries;
exports.shouldDeferEmailForRetry = shouldDeferEmailForRetry;
...
function getEmailErrorSummary(error) {
...
function getEmailTransientMaxRetries() {
...
function shouldDeferEmailForRetry(error, currentRetryCount) {
