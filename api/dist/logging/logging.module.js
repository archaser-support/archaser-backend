...
const mongo_log_service_1 = require("./mongo-log.service");
let LoggingModule = class LoggingModule {
};
exports.LoggingModule = LoggingModule;
exports.LoggingModule = LoggingModule = __decorate([
    (0, common_1.Module)({
        providers: [loki_transport_service_1.LokiTransportService, mongo_log_service_1.MongoLogService],
        exports: [loki_transport_service_1.LokiTransportService, mongo_log_service_1.MongoLogService],
    })
], LoggingModule);
