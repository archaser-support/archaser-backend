...
exports.emptyEffectiveCustomerPolicyFields = emptyEffectiveCustomerPolicyFields;
exports.mapCustomerPolicyRow = mapCustomerPolicyRow;
exports.effectivePolicyFieldsToCustomerDisplay = effectivePolicyFieldsToCustomerDisplay;
function emptyEffectiveCustomerPolicyFields() {
    return {
...
function mapCustomerPolicyRow(row) {
    return {
        ...
        payment_term_substitute_day_of_month: row.payment_term_substitute_day_of_month,
...
function effectivePolicyFieldsToCustomerDisplay(fields) {
    return {
...
//# sourceMappingURL=customerPolicyTypes.js.map