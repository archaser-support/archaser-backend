...
const realtime_ws_controller_1 = require("./realtime-ws.controller");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [realtime_ws_controller_1.RealtimeWsController],
        providers: [realtime_hub_service_1.RealtimeHubService],
        exports: [realtime_hub_service_1.RealtimeHubService],
    })
], RealtimeModule);
