...
import { CustomerActivityQuery, CustomersListQuery, CustomersService, CustomerTopUpsQuery } from "./customers.service";
export declare class CustomersController {
    private readonly customers;
    private readonly checkpoints;
    constructor(customers: CustomersService, checkpoints: CustomerCheckpointService);
    ...
    topUps(user: JwtPayload, id: number, query: CustomerTopUpsQuery): Promise<{
        data: {
            policy_number: string;
            insurer_name: string | null;
            id: number;
    ...
    checkpointStatus(user: JwtPayload, id: number): Promise<import("./customer-checkpoint.service").CustomerCheckpointStatus>;
    checkpointSave(user: JwtPayload, id: number): Promise<import("./customer-checkpoint.service").CustomerCheckpointStatus>;
    checkpointRestore(user: JwtPayload, id: number): Promise<import("./customer-checkpoint.service").CustomerCheckpointRestoreSummary>;
    ...
    addComment(user: JwtPayload, id: number, body: {
        comment?: string;
        content?: string;
    }): Promise<{
        id: bigint;
