...
let BusinessUnitsController = class BusinessUnitsController {
    constructor(businessUnits) {
        this.businessUnits = businessUnits;
    }
    async validateAccess(user, body) {
...
], BusinessUnitsController.prototype, "validateAccess", null);
exports.BusinessUnitsController = BusinessUnitsController = __decorate([
    (0, swagger_1.ApiTags)("business-units"),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(dual_auth_guard_1.DualAuthGuard),
    (0, common_1.Controller)("api/business-units"),
