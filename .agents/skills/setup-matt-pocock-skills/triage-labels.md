...
The skills speak in terms of five canonical triage roles plus local implementation lifecycle statuses. This file maps those roles to the actual label strings used in this repo's issue tracker.
